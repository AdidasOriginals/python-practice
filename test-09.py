...
# @Time : 2021/1/19 18:46 
# @Author : Edison
# @Version：V 0.1
# @File : test-09.py
# @desc :面向对象进阶
print('@property装饰器'.center(50, '-'))
...
main5()
print('重写（override）多态'.center(50, '-'))
